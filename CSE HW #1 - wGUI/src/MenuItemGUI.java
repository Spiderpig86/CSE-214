 ...
 * for the <code>MenuItem</code> objects added to the MenuGUI
 * class.
 *
 *
 * @author M. D. W.
...
public class MenuItemGUI {
     ...
     *          range.
     */
    public MenuItemGUI(String name, String description, double price) {
        itemName = name;
        itemDescription = description;

        if (price < 0)
            throw new IllegalArgumentException("Error: The value of the " +
    ...
    public void setItemPrice(double price) throws IllegalArgumentException {
            if (price > 0)
                ...
                throw new IllegalArgumentException("Cannot set a negative " +
                        "value for the price.");
    }
     ...
     */
    public MenuItemGUI clone() {
        MenuItemGUI item = new MenuItemGUI(getItemName(),
                getItemDescription(), getItemPrice());
        return item;
    }
    ...
    public boolean equals(Object obj) {
        MenuItemGUI item = (MenuItemGUI) obj;
